...
namespace API
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // string urlStr = "?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=1541314361&numbers=LN343773252KR&orders=&lang=en";
            // string requestData = null;
            ...
            // string urlstr = null;
            // string requestdata = "{\"tracking_number\": \"LN343773252KR\",\"carrier_code\":\"korea-post\",\"destination_code\":\"{destination_code}\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
